    ...
    children: [
      {
        ...
        name: 'Service List',
        meta: { title: 'Service List', icon: 'el-icon-s-data', affix: true }
      },
      {
        path: 'create_http',
